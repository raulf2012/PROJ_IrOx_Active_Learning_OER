...
def get_trace_i(
    ...
    # min_E = data_i["prediction_not_ref"].data.min()
    #
...
def process_data(stoich_i=None):
    """
    Args:
        stoich_i: "iro2" or "iro3"
    out:
        models_list, layout, get_trace_i, sliders_dict, get_slider_step_i
    """
