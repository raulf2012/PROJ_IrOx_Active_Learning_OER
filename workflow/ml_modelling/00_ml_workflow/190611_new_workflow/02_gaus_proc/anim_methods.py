...
#
#         if "prediction_unstandardized_" in col_j:
#             # data_i["prediction"] = grid.get_column_reference(col_j)
#             data_i["prediction_unstandardized"] = grid.get_column(col_j).data
#             # data_i["prediction_not_ref"] = grid.get_column(col_j).data
#
#         elif "prediction_" in col_j:
#             # data_i["prediction"] = grid.get_column_reference(col_j)
#             data_i["prediction"] = grid.get_column(col_j).data
#             data_i["prediction_not_ref"] = grid.get_column(col_j).data
#         elif "x_axis_index_" in col_j:
#             # data_i["x_axis_index"] = grid.get_column_reference(col_j)
#             data_i["x_axis_index"] = grid.get_column(col_j).data
#
#         elif "uncertainty_" in col_j:
#             data_i["uncertainty"] = grid.get_column(col_j).data
#
#         elif "actually_computed_" in col_j:
#             data_i["actually_computed"] = grid.get_column(col_j).data
#
