...
# #############################################################################
from inputs import gens_to_plot
...
path_i = os.path.join(
    ...
    "workflow/ml_modelling/00_ml_workflow/191102_new_workflow/performance_comp/top_10_disc_vs_dft/out_data",
...
path_i = os.path.join(
    "out_data",
    # stoich_i + "_" + "figs_dict__v2.pickle")
...
# +
# y_range_inset_dict[1].pop("padding")

# y_range_inset_dict[1]
...
minor_ticks_data["main_al_plots"]["x"]
