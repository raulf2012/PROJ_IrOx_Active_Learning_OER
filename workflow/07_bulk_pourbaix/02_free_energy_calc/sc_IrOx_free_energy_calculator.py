...
"""Energetic treatment for bulk Pourbaix diagram.

Author: Michal Bajdich, Raul Flores
"""
...
# dE relative to -241.81/kjmol

o_ref2_de = h2o_ref - 2 * h_ref + 2.506 - (o2zpe + o2cp) / 2
...
print(
    'Error for dH of H2O, 1/2 O2 ref fitted ',
    h2o_ref - 2 * h_ref - o_ref2 - (-241.81 / kjmol),
...
print(
    '1/2 O2 ref fitted to dH of H2O ',
    o_ref2,
    ' PBE 1/2 O2 ref: ',
    o_ref1,
    ' 1/2 H2 ref. ',
...
print(
    'Error for dG of H2O, 1/2 O2 ref fitted: ',
    (h2o_ref - 2 * h_ref - o_ref2 -
        (tsh2o - tsh2 - 0.5 * tso2)) - (-237.140 / kjmol),
    ' should be close to zero!',
    )

print(
    'Error for dG of H2O: 1/2 O2 ref PBE   : ',
    (h2o_ref - 2 * h_ref - o_ref1 -
        (tsh2o - tsh2 - 0.5 * tso2)) - (-237.140 / kjmol),
    )
#__|
...
print(
    'Calculated Ir metal ref : ',
    ir_metal,
    ' vs. fitted to IrO2 dH : ',
    ir_metal_fit,
    )
#__|
