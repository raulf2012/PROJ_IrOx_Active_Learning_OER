...
iro2=-7.049062*3 #calculated Rutile PBE energy, 600 eV
iro3=-6.469847*4 #calculated lowest PBE energy , 600 eV
...
print("ir_metal_fit:", ir_metal_fit)

print("IrO2 (exp)", -242.672 / kjmol)
